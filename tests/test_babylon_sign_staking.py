...
#     assert bip0340.schnorr_verify(sighash0, partial_sig0.pub6key, partial_sig0.signature[:64]), "signature veriry fail"
...
# def test_sign_psbt_bip322_message(navigator: Navigator, firmware: Firmware, client:
#                                        RaggerClient, test_name: str):
...
#     BIP-0322 test
#     PADDING MESSAGE
#     ASCII of message || (32 - message_len)*0xFC
...
#         [
#             "[f5acc2fd/86'/1'/0']tpubDDKYE6BREvDsSWMazgHoyQWiJwYaDDYPbCFjYxN3HFXJP5fokeiK4hwK5tTLBNEDBwrDXn8cQ4v9b2xdW62Xr5yxoQdMu1v6c7UDXYVH27U",
#             "[83871619/86'/1'/0']tpubDDKYE6BREvDsSWMazgHoyQWiJwYaDDYPbCFjYxN3HFXJP5fokeiK4hwK5tTLBNEDBwrDXn8cQ4v9b2xdW62Xr5yxoQdMu1v6c7UDXYVH27U",#message
#             "[25270417/86'/1'/0']tpubDDKYE6BREvDsSWMazgHoyQWiJwYaDDYPbCFjYxN3HFXJP5fokeiK4hwK5tTLBNEDBwrDXn8cQ4v9b2xdW62Xr5yxoQdMu1v6c7UDXYVH27U",#tap pubkey
#         ],
#     )
